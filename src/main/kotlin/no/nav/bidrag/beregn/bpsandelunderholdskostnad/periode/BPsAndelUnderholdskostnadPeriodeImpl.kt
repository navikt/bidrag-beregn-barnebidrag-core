...
class BPsAndelUnderholdskostnadPeriodeImpl(private val bPsAndelUnderholdskostnadBeregning: BPsAndelUnderholdskostnadBeregning) :
    ...
    override fun beregnPerioder(grunnlag: BeregnBPsAndelUnderholdskostnadGrunnlag): BeregnetBPsAndelUnderholdskostnadResultat {
        ...
        // Lag bruddperioder
        lagBruddperioder(periodeGrunnlag = grunnlag, beregnBPsAndelUnderholdskostnadListeGrunnlag = beregnBPsAndelUnderholdskostnadListeGrunnlag)
    ...
    private fun justerDatoerGrunnlagslister(
        ...
        beregnBPsAndelUnderholdskostnadListeGrunnlag.justertSjablonPeriodeListe = periodeGrunnlag.sjablonPeriodeListe
            .map { SjablonPeriode(it) }

        beregnBPsAndelUnderholdskostnadListeGrunnlag.justertUnderholdskostnadPeriodeListe = periodeGrunnlag.underholdskostnadPeriodeListe
            .map { UnderholdskostnadPeriode(it) }

        beregnBPsAndelUnderholdskostnadListeGrunnlag.justertInntektBPPeriodeListe = periodeGrunnlag.inntektBPPeriodeListe
        ...
        beregnBPsAndelUnderholdskostnadListeGrunnlag.justertInntektBBPeriodeListe = periodeGrunnlag.inntektBBPeriodeListe
            .map { InntektPeriode(it) }
    }
    ...
    private fun lagBruddperioder(
        ...
        beregnBPsAndelUnderholdskostnadListeGrunnlag.bruddPeriodeListe = Periodiserer()
    ...
    private fun beregnBPsAndelUnderholdskostnadPerPeriode(grunnlag: BeregnBPsAndelUnderholdskostnadListeGrunnlag, soknadsbarnPersonId: Int) {
        grunnlag.bruddPeriodeListe.forEach { beregningsperiode ->
            ...
            val brukNyeRegler = beregningsperiode.getPeriode().datoTil == null ||
