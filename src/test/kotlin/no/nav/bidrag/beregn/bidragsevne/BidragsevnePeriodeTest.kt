...
internal class BidragsevnePeriodeTest {
    ...
    fun testMedOKGrunnlag() {
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].grunnlag.inntektListe[0].belop,
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[3].grunnlag.inntektListe[0].belop,
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[4].grunnlag.inntektListe[0].belop,
                ).isEqualTo(BigDecimal.valueOf(666001))
            },
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[5].grunnlag.inntektListe[0].belop,
                ).isEqualTo(BigDecimal.valueOf(666001))
            },
    ...
    fun testGrunnlagMedAvvik() {
        ...
        assertAll(
            ...
            Executable { assertThat(avvikListe).hasSize(31) },
            Executable {
                assertThat(
    ...
    private fun lagSjablonGrunnlag() = listOf(
        ...
        SjablonPeriode(
            ...
            Sjablon(
                ...
                listOf(
                    SjablonInnhold(
                        SjablonInnholdNavn.INNTEKTSGRENSE_BELØP.navn,
        ...
        SjablonPeriode(
            ...
            Sjablon(
                ...
                listOf(
                    SjablonNokkel(
                        SjablonNøkkelNavn.BOSTATUS.navn,
                        "EN",
                    ),
                ),
                listOf(
                    SjablonInnhold(
                        SjablonInnholdNavn.BOUTGIFT_BELØP.navn,
                        BigDecimal.valueOf(9303),
                    ),
                    SjablonInnhold(
                        SjablonInnholdNavn.UNDERHOLD_BELØP.navn,
