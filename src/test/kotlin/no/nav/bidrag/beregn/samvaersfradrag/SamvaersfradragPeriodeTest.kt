...
internal class SamvaersfradragPeriodeTest {
    ...
    fun testToPerioder() {
        ...
        val grunnlag = BeregnSamvaersfradragGrunnlag(
        ...
        val sjablonPeriodeListe = listOf(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    navn = SjablonNavn.SAMVAERSFRADRAG.navn,
                    nokkelListe = listOf(
                        SjablonNokkel(navn = SjablonNokkelNavn.SAMVAERSKLASSE.navn, verdi = "01"),
                        SjablonNokkel(navn = SjablonNokkelNavn.ALDER_TOM.navn, verdi = "5")
                    ),
                    innholdListe = listOf(
                        ...
                        SjablonInnhold(navn = SjablonInnholdNavn.FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(219))
                    )
                )
            ),
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.ANTALL_DAGER_TOM.navn, verdi = BigDecimal.valueOf(3)),
                        SjablonInnhold(navn = SjablonInnholdNavn.ANTALL_NETTER_TOM.navn, verdi = BigDecimal.valueOf(3)),
                        SjablonInnhold(navn = SjablonInnholdNavn.FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(318))
                    )
                )
            ),
            SjablonPeriode(
