...
class SamvaersfradragCoreTest {
    ...
    fun skalBeregneSamvaersfradrag() {
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[0].periode.datoFom,
                ).isEqualTo(LocalDate.parse("2017-01-01"))
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[0].periode.datoTil,
                ).isEqualTo(LocalDate.parse("2018-01-01"))
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[0].resultat.belop,
            ...
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[1].periode.datoFom,
                ).isEqualTo(LocalDate.parse("2018-01-01"))
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[1].periode.datoTil,
                ).isEqualTo(LocalDate.parse("2019-01-01"))
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[1].resultat.belop,
                ).isEqualTo(BigDecimal.valueOf(667))
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[2].periode.datoFom,
                ).isEqualTo(LocalDate.parse("2019-01-01"))
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[2].periode.datoTil,
                ).isEqualTo(LocalDate.parse("2020-01-01"))
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.resultatPeriodeListe[2].resultat.belop,
    ...
    fun skalIkkeBeregneAndelVedAvvik() {
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.avvikListe[0].avvikTekst,
                ).isEqualTo("beregnDatoTil må være etter beregnDatoFra")
            },
            Executable {
                assertThat(
                    beregnSamvaersfradragResultatCore.avvikListe[0].avvikType,
