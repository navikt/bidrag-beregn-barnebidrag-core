...
internal class BarnebidragPeriodeTest {
    ...
    fun enkelTestEttBarnToBidragsevner() {
        ...
        val bPsAndelUnderholdskostnadListe =
            listOf(
                BPsAndelUnderholdskostnadPeriode(
                    ...
                    bPsAndelUnderholdskostnadPeriode =
                    Periode(
                        datoFom = LocalDate.parse("2019-08-01"),
                        datoTil = LocalDate.parse("2020-01-01"),
                    ),
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].resultatListe[0].belop.compareTo(BigDecimal.valueOf(15000)),
                ).isZero()
            },
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].resultatListe[0].kode,
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[1].resultatListe[0].belop.compareTo(BigDecimal.valueOf(16000)),
                ).isZero()
            },
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[1].resultatListe[0].kode,
    ...
    fun testVariabeltAntallBarn() {
        ...
        val bPsAndelUnderholdskostnadListe =
            listOf(
                BPsAndelUnderholdskostnadPeriode(
                    ...
                    Periode(
                        datoFom = LocalDate.parse("2019-08-01"),
                        datoTil = LocalDate.parse("2019-10-01"),
                    ),
        ...
        val samvaersfradragPeriodeListe =
            listOf(
                ...
                SamvaersfradragPeriode(
                    soknadsbarnPersonId = 3,
                    referanse = SAMVÆRSFRADRAG_REFERANSE + "_4",
                    samvaersfradragPeriode = Periode(datoFom = LocalDate.parse("2019-08-01"), datoTil = LocalDate.parse("2020-01-01")),
                    belop = BigDecimal.ZERO,
                ),
            )
        ...
        val barnetilleggForsvaretPeriodeListe =
            listOf(
                BarnetilleggForsvaretPeriode(
                    ...
                    Periode(
                        datoFom = LocalDate.parse("2019-08-01"),
                        datoTil = LocalDate.parse("2019-12-01"),
                    ),
                    barnetilleggForsvaretIPeriode = false,
                ),
                BarnetilleggForsvaretPeriode(
                    ...
                    barnetilleggForsvaretPeriode =
                    Periode(
                        datoFom = LocalDate.parse("2019-12-01"),
                        datoTil = LocalDate.parse("2020-01-01"),
                    ),
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[2].resultatListe[0].kode,
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[3].resultatListe[0].kode,
    ...
    fun testDeltBosted() {
        ...
        val bPsAndelUnderholdskostnadListe =
            listOf(
                BPsAndelUnderholdskostnadPeriode(
                    ...
                    Periode(
                        datoFom = LocalDate.parse("2019-08-01"),
                        datoTil = LocalDate.parse("2019-11-01"),
                    ),
                ...
                BPsAndelUnderholdskostnadPeriode(
                    ...
                    bPsAndelUnderholdskostnadPeriode =
                    Periode(
                        datoFom = LocalDate.parse("2019-11-01"),
                        datoTil = LocalDate.parse("2020-01-01"),
                    ),
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[1].resultatListe[1].kode,
    ...
    fun testGrunnlagMedAvvik() {
        ...
        assertAll(
            ...
            Executable {
                ...
                ).isEqualTo("Første dato i bidragsevnePeriodeListe (2019-08-01) er etter beregnDatoFom (2016-08-01)")
            },
    ...
    private fun lagSjablonliste() {
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon =
                Sjablon(
                    navn = SjablonTallNavn.BARNETILLEGG_FORSVARET_FØRSTE_BARN_BELØP.navn,
                    nokkelListe = emptyList(),
                    innholdListe =
                    listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(5667)),
                    ),
                ),
            ),
        )
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon =
                Sjablon(
                    navn = SjablonTallNavn.BARNETILLEGG_FORSVARET_ØVRIGE_BARN_BELØP.navn,
                    nokkelListe = emptyList(),
                    innholdListe =
                    listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(2334)),
                    ),
                ),
            ),
        )
