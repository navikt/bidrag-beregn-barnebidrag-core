...
internal class BarnebidragCoreTest {
    ...
    fun skalBeregneBarnebidrag() {
        ...
        assertAll(
            ...
            Executable { assertThat(beregnBarnebidragResultatCore.resultatPeriodeListe[0].periode.datoFom).isEqualTo(LocalDate.parse("2017-01-01")) },
            Executable { assertThat(beregnBarnebidragResultatCore.resultatPeriodeListe[0].periode.datoTil).isEqualTo(LocalDate.parse("2018-01-01")) },
            Executable {
            ...
            Executable { assertThat(beregnBarnebidragResultatCore.resultatPeriodeListe[0].grunnlagReferanseListe[4]).isEqualTo(BIDRAGSEVNE_REFERANSE) },
            Executable {
            ...
            Executable { assertThat(beregnBarnebidragResultatCore.resultatPeriodeListe[0].grunnlagReferanseListe[6]).isEqualTo(DELT_BOSTED_REFERANSE) },
            Executable {
