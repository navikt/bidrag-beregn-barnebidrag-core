...
internal class ForholdsmessigFordelingPeriodeTest {
    ...
    fun testPeriodiseringToSakerToPerioderEttBarnHverFullEvne() {
        ...
        val beregnForholdsmessigFordelingGrunnlag =
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].resultatBeregningListe[0].resultatPerBarnListe[0].barnPersonId,
                ).isEqualTo(1)
            },
        )
    }
        ...
        assertAll(
            ...
            Executable {
                assertThat(resultat.resultatPeriodeListe[1].resultatBeregningListe[0].resultatPerBarnListe[0].kode).isEqualTo(
                    ResultatkodeBarnebidrag.FORHOLDSMESSIG_FORDELING_BIDRAGSBELØP_ENDRET,
                )
            },
            Executable {
                assertThat(
