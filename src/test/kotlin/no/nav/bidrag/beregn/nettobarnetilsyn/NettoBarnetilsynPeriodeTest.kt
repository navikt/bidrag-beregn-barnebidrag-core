...
internal class NettoBarnetilsynPeriodeTest {
    ...
    fun testPeriodiseringEttBarn() {
        val faktiskUtgiftPeriodeListe = listOf(
        ...
        assertAll(
            ...
            Executable { assertThat(resultat.resultatPeriodeListe[0].grunnlag.faktiskUtgiftListe[0].belop.compareTo(BigDecimal.valueOf(1000))).isZero() },
            Executable { assertThat(resultat.resultatPeriodeListe[0].resultatListe[0].belop.compareTo(BigDecimal.valueOf(750))).isZero() },

            Executable { assertThat(resultat.resultatPeriodeListe[1].grunnlag.faktiskUtgiftListe[0].belop.compareTo(BigDecimal.valueOf(2000))).isZero() },
            Executable { assertThat(resultat.resultatPeriodeListe[1].resultatListe[0].belop.compareTo(BigDecimal.valueOf(1499))).isZero() },

            Executable { assertThat(resultat.resultatPeriodeListe[2].grunnlag.faktiskUtgiftListe[0].belop.compareTo(BigDecimal.valueOf(5000))).isZero() },
    ...
    fun testPeriodiseringToBarn() {
        ...
        assertAll(
            ...
            Executable { assertThat(resultat.resultatPeriodeListe[1].grunnlag.faktiskUtgiftListe[1].belop.compareTo(BigDecimal.valueOf(2000))).isZero() },
    ...
    fun testGrunnlagMedAvvik() {
        ...
        assertAll(
            ...
            Executable { assertThat(avvikListe[0].avvikTekst).isEqualTo("Første dato i faktiskUtgiftPeriodeListe (2018-07-01) er etter beregnDatoFra (2017-07-01)") },
            Executable { assertThat(avvikListe[0].avvikType).isEqualTo(AvvikType.PERIODE_MANGLER_DATA) },
            Executable { assertThat(avvikListe[1].avvikTekst).isEqualTo("Siste dato i faktiskUtgiftPeriodeListe (2020-01-01) er før beregnDatoTil (2021-01-01)") },
    ...
    private fun lagSjablonGrunnlag() = listOf(
        ...
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                ...
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "1")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(2083.33))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "2")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(3333))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "3")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(4583))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "4")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(5833))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "5")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(7083))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "6")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(8333))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "7")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(9583))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "8")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(10833))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                navn = SjablonNavn.MAKS_FRADRAG.navn,
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "99")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_FRADRAG_BELOP.navn, verdi = BigDecimal.valueOf(12083))
                )
            )
        ),
        ...
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                ...
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "1")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_TILSYN_BELOP.navn, verdi = BigDecimal.valueOf(6214))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                ...
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "2")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_TILSYN_BELOP.navn, verdi = BigDecimal.valueOf(8109))
                )
            )
        ),
        SjablonPeriode(
            ...
            sjablon = Sjablon(
                ...
                nokkelListe = listOf(SjablonNokkel(navn = SjablonNokkelNavn.ANTALL_BARN_TOM.navn, verdi = "99")),
                innholdListe = listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.MAKS_TILSYN_BELOP.navn, verdi = BigDecimal.valueOf(9189))
                )
            )
        ),
