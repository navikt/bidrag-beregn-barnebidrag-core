...
internal class NettoBarnetilsynCoreTest {
    ...
    fun skalBeregneNettoBarnetilsyn() {
        ...
        assertAll(
            ...
            Executable { assertThat(beregnNettoBarnetilsynResultatCore.resultatPeriodeListe[0].periode.datoFom).isEqualTo(LocalDate.parse("2017-01-01")) },
            Executable { assertThat(beregnNettoBarnetilsynResultatCore.resultatPeriodeListe[0].periode.datoTil).isEqualTo(LocalDate.parse("2018-01-01")) }
        )
    }
