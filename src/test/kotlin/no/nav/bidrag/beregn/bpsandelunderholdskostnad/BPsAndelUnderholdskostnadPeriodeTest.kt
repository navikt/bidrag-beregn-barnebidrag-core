...
internal class BPsAndelUnderholdskostnadPeriodeTest {
    ...
    fun testPeriodisering() {
        val resultat =
            bPsAndelunderholdskostnadPeriode.beregnPerioder(
                lagGrunnlag(beregnDatoFra = "2018-07-01", beregnDatoTil = "2020-08-01"),
            )
    ...
    fun testBeregningMedGamleOgNyeRegler() {
            ...
            listOf(
                SjablonPeriode(
                    ...
                    Sjablon(
                        ...
                        innholdListe =
                        listOf(
                            SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(1600)),
                        ),
                    ),
                ),
                SjablonPeriode(
                    ...
                    Sjablon(
                        ...
                        innholdListe =
                        listOf(
                            SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(1700)),
                        ),
                    ),
                ),
            )
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].resultat.andelProsent,
                ).isEqualTo(BigDecimal.valueOf(0.333))
            }, // Gamle regler
        ...
        assertAll(
            ...
            Executable {
                assertThat(avvikListe[2].avvikTekst)
                    .isEqualTo("Første dato i inntektBPPeriodeListe (2018-01-01) er etter beregnDatoFom (2016-01-01)")
            },
    ...
    fun testUtvidetBarnetrygdBM() {
        ...
        assertAll(
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].grunnlag.inntektBMListe[0].type,
                ).isEqualTo("PENSJON_KORRIGERT_BARNETILLEGG")
            },
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].grunnlag.inntektBMListe[0].belop,
            ...
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].grunnlag.inntektBMListe[1].belop,
                ).isEqualTo(BigDecimal.valueOf(12000))
            },
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].grunnlag.inntektBMListe[2].type,
                ).isEqualTo("FORDEL_SAERFRADRAG_ENSLIG_FORSORGER")
            },
            Executable {
                assertThat(
                    resultat.resultatPeriodeListe[0].grunnlag.inntektBMListe[2].belop,
                ).isEqualTo(BigDecimal.valueOf(13000))
            },
        )
    }

    private fun lagGrunnlag(beregnDatoFra: String, beregnDatoTil: String) = BeregnBPsAndelUnderholdskostnadGrunnlag(
    ...
    private fun lagSjablonGrunnlag() = listOf(
        ...
        SjablonPeriode(
            ...
            Sjablon(
                ...
                innholdListe =
                listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(1640)),
                ),
            ),
        ),
        SjablonPeriode(
            ...
            Sjablon(
                ...
                innholdListe =
                listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(1670)),
                ),
            ),
        ),
    )
    ...
    private fun lagSjablonGrunnlagUtvidetBarnetrygd() = listOf(
        ...
        SjablonPeriode(
            ...
            sjablon =
            Sjablon(
                navn = SjablonTallNavn.ØVRE_INNTEKTSGRENSE_IKKE_I_SKATTEPOSISJON_BELØP.navn,
                nokkelListe = emptyList(),
                innholdListe =
                listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(105000)),
                ),
            ),
        ),
        // Sjablon 0031
        SjablonPeriode(
            ...
            sjablon =
            Sjablon(
                navn = SjablonTallNavn.NEDRE_INNTEKTSGRENSE_FULL_SKATTEPOSISJON_BELØP.navn,
                nokkelListe = emptyList(),
                innholdListe =
                listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(105000)),
        ...
        SjablonPeriode(
            ...
            Sjablon(
                ...
                innholdListe =
                listOf(
                    SjablonInnhold(navn = SjablonInnholdNavn.SJABLON_VERDI.navn, verdi = BigDecimal.valueOf(13000)),
                ),
            ),
        ),
    )
